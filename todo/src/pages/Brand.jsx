        ...
        return (
            <div className="min-h-screen w-full flex items-center justify-center p-6">
                <div className="bg-white w-full max-w-2xl p-10 rounded-2xl shadow-xl text-center">
                    ...
                    <p className="text-gray-600 mb-6">Please login again to access brands.</p>
                    <button
                ...
                <div className="bg-white rounded-2xl shadow-lg overflow-hidden mb-8">
                    <div className="bg-gradient-to-r from-blue-600 to-indigo-700 px-6 py-4">
                        ...
                        <p className="text-blue-100 text-sm mt-1">
                            {editId ? "Update brand details" : "Fill in the brand information below"}
                        </p>
                    </div>
                    ...
                    <div className="p-6 md:p-8">
                            ...
                            <div className="col-span-1 md:col-span-2">
                                <div>
                                    ...
                                    <input
                                        ...
                                        disabled={loading}
                                    />
                                    <p className="text-xs text-gray-500 mt-1">Brands help identify product manufacturers</p>
                                </div>
                            </div>
                                    ...
                                    <label className="flex items-center space-x-3 cursor-pointer p-4 bg-gray-50 rounded-xl border border-gray-200">
                                        ...
                                        <div>
                                            ...
                                            <p className="text-xs text-gray-500 mt-0.5">
                                                Active brands are available for product selection
                                            </p>
                                        </div>
                                    </label>
                                )}
                        ...
                        <div className="flex justify-start gap-4 mt-8 pt-4 border-t border-gray-200">
                            ...
                            >
                                {loading ? "Saving..." : (editId ? "Update Brand" : "Add Brand")}
                            </button>
                            {editId && (
                                <button
                                    onClick={cancelEdit}
                        ...
                        <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center gap-4">
                            ...
                            <div className="flex items-center space-x-3 bg-gray-700/50 px-4 py-2 rounded-xl">
                                <label className="flex items-center space-x-2 cursor-pointer">
                                    ...
                                    />
                                    <span className="text-sm text-gray-200">Show inactive brands</span>
                                </label>
                            </div>
                        </div>
                    </div>
                    ...
                    <div className="p-6">
                        <div className="mb-4 flex justify-between items-center">
                            <div className="text-sm text-gray-600">
                                Showing {filteredList.length} of {list.length} brands
                            </div>
                        </div>
                        ...
                        {loading && list.length === 0 ? (
                            ...
                            <div className="text-center py-12 bg-gray-50 rounded-xl">
                                ...
                                <p className="text-gray-600">
                                    {showInactive ? "No brands found." : "No active brands found. Toggle 'Show inactive brands' to view all."}
                                </p>
                            </div>
                        ) : (
