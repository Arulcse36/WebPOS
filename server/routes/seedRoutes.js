...
const categories = await Category.insertMany([
 ...
 // Insert Products - 1000+ products
    const products = await Product.insertMany([
      ...
      { productCode: "GRO-060", name: "Besan - Nos Flour (1kg)", tamilName: "கடலை மாவு (1கிலோ)", mrp: 80, retailRate: 75, wholesaleRate: 70, category: categoryMap["Flours"], brand: brandMap["Taj"], uom: uomMap["Kg"], isActive: true, companyId: COMPANY_ID },
      ...
      { productCode: "GRO-095", name: "HorseNos - Kollu (1kg)", tamilName: "கொள்ளு (1கிலோ)", mrp: 85, retailRate: 80, wholesaleRate: 76, category: categoryMap["Dals & Pulses"], brand: brandMap["Local"], uom: uomMap["Kg"], isActive: true, companyId: COMPANY_ID },
